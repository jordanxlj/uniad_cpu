...
from projects.mmdet3d_plugin.core.bbox.transforms import bbox3d2result
#from mmdet3d.core.bbox.coders import build_bbox_coder
from mmdet.core.bbox import build_bbox_coder
#from mmdet3d.models.detectors.mvx_two_stage import MVXTwoStageDetector
from projects.mmdet3d_plugin.uniad.detectors.mvx_two_stage import MVXTwoStageDetector
...
class UniADTrack(MVXTwoStageDetector):
    ...
    def _forward_single_frame_inference(
        ...
        track_instances.scores = track_scores
        # track_instances.track_scores = track_scores  # [901]
        track_instances.pred_logits = output_classes[-1, 0]  # [901, num_cls]
        track_instances.pred_boxes = output_coords[-1, 0]  # [901, box_dim]
        track_instances.output_embedding = query_feats[-1][0]  # [901, feat_dim]
